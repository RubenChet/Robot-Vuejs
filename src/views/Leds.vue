<template>
  <div class="div_container">
    ...
    <div class="ledsColor">
      <div class="btns">
        <v-btn color="red" plain elevation="4" v-on:click="pub('C.255,0,0,15')">RED</v-btn>
        <v-btn color="green" plain elevation="4" v-on:click="pub('C.0,255,0,15')">GREEN</v-btn>
        <v-btn color="blue" plain elevation="4" v-on:click="pub('C.0,0,255,15')">BLUE</v-btn>
      </div>
    </div>
    <div class="ledsRGB">
